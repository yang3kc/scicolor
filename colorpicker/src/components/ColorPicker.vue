...
const color_list_to_show = computed(() => {
  console.log("Computing color list to show");
...
<template>
  ...
  <div>
    <div class="flex justify-center">
      <div class="btn btn-sm btn-outline w-20 mr-2" @click="shuffle_color_list">
        Shuffle
      </div>
      <div class="btn btn-sm btn-outline w-20" @click="restore_color_list">
        Restore
      </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-2 md:max-w-xl mx-auto">
